...
module.exports = {
  ...
  format__general(event) {
    ...
    */
    ...
    var tags = split_event[0].charAt(0) === '@' ? split_event.shift() : undefined;
    var chatterTags = {};
    if(tags) {
      tags = tags.substr(1);      // drop the first character "@"
      tags = tags.split(';');     // turn the object from a string to an array
      tags.forEach((tag, idx) => {
        tags[tag.split('=')[1]] = tag.split('=')[0];
        delete tags[idx];
