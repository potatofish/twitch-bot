...
module.exports = {
  ...
  format__general(event) {
    ...
    */
    ...
    ircEvent.toBeParsed = event.slice(ircEvent.tags.length); // removed the processed characters

    ircEvent.clientPrefix = ircEvent.toBeParsed.split(" ").shift();
    ircEvent.toBeParsed = event.slice(ircEvent.clientPrefix.length); // removed the processed characters

    ircEvent.command = ircEvent.toBeParsed.split(" ").shift();
    ircEvent.toBeParsed = event.slice(ircEvent.command.length); // removed the processed characters

    ircEvent.channel = ircEvent.toBeParsed.split(" ").shift();
    ircEvent.toBeParsed = event.slice(ircEvent.channel.length); // removed the processed characters

    ircEvent.user = ircEvent.toBeParsed.split("\r\n").shift();
    ircEvent.toBeParsed = event.slice(ircEvent.user.length); // removed the processed characters
