  ...
  format__general(event) {
    ...
    */
    function format__line(message) {
      ...
      // The arguments for each command can have different syntax
      ircMessage.content = unParsedMsg.slice(ircMessage.command.length + 1);
      ircMessage.args = divideArgs(ircMessage.command, ircMessage.args);
